...
#elif INT0_SENSE_CTRL == EXTI_FAILLING_EDGE
	CLR_BIT(MCUCR, MCUCR_ISC00);
...
#elif INT1_SENSE_CTRL == EXTI_FAILLING_EDGE
	CLR_BIT(MCUCR, MCUCR_ISC10);
...
#if INT2_SENSE_CTRL == EXTI_FAILLING_EDGE
...
uint8 EXTI_u8SetSenseCtrl(IntChannel_t Copy_IntCh, SenseCtrl_t Copy_SenseCtrl)
{
	...
	if(Copy_IntCh == INT0)
	{
		...
		case EXTI_FAILLING_EDGE : CLR_BIT(MCUCR, MCUCR_ISC00); SET_BIT(MCUCR, MCUCR_ISC01); break;
	...
	else if(Copy_IntCh == INT1)
	{
		...
		case EXTI_FAILLING_EDGE : CLR_BIT(MCUCR, MCUCR_ISC10); SET_BIT(MCUCR, MCUCR_ISC11); break;
	...
	else if(Copy_IntCh == INT2)
	{
		switch(Copy_SenseCtrl)
		{
		case EXTI_FAILLING_EDGE : CLR_BIT(MCUCSR, MCUCSR_ISC2); break;
